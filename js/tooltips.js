...
function show_err_msg(msg){
	 ...
	 var errhtml='<div  class="bac" style="padding:8px 0px;border:1px solid #ff0000;width:380px;margin:0 auto;background-color:#fff;color:#B90802;border:3px #ff0000 solid;text-align:center;font-size:16px;font-family:微软雅黑;"><img style="margin-right:10px;" src="images/error.png">';
	 var errhtmlfoot='</div>';	 
